...
contract PufferTest is Test {
    ...
    function setUp() public {
        // The EigenLayer stETH deposit limit was increased on 18814787 during this transaction:
        // https://etherscan.io/tx/0xc16610a3dc3e8732e3fbb7761f6e1c0e44869cba5a41b058d2b3abce98833667
        // By forking to block 18812842, tests will start BEFORE the EL update
    ...
    function _increaseELstETHCap() public {
        // Fast-Forwards past block 18814787 where EigenLayer stETH deposit limit was increased:
        // https://etherscan.io/tx/0xc16610a3dc3e8732e3fbb7761f6e1c0e44869cba5a41b058d2b3abce98833667
        vm.roll(18819958); // TODO Choose something > 18814787 
